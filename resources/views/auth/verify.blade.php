                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                        <form class="d-inline" method="POST" id="resend" action="{{ route('verification.resend') }}">
                                            @csrf
                                                <td> <a href="javascript:;" id="resend_button">click here to request another</a> </td>
                                        </form>
                        ...
                        <p>If you received email and  by mistake your delete.Then click the link above to get new request.</p>
